...
const UnderProcessingOrders = () =>{

    const userState = useSelector(state => state.auth)
    const [orderList, setOrderList] = useState([])
    
    useEffect(() => {
        fetch(`${API}/get/seller/orders/processing/${userState.user.businessId._id}/${userState.user._id}`, {
            method: "GET",
            headers: {
...
export default UnderProcessingOrders