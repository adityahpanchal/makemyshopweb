        ...
        <>
            {
                ...
                <div class="form-group">
                    ...
                    </div>
                    {
                        ...
                        <div className="pb-3">
                            <h5>Images</h5>
                            <button className="btn btn-info" onClick={() => document.getElementById('22343467576586').click()}>Select Files</button>
                        </div>
                        </>
                    }
                    <div class="modal-footer pb-0">
                            {replace && <button type="button" onClick={() => nxtbtnwithupdate()} class="btn btn-secondary">Add</button>}
